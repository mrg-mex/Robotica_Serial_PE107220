...
theta1sim1 = theta1_in(1)+((10/T^3)*t^3-(15/T^4)*t^4+(6/T^5)*t^5)*(theta1_fin(1)-theta1_in(1));
theta2sim1 = theta2_in(1)+((10/T^3)*t^3-(15/T^4)*t^4+(6/T^5)*t^5)*(theta2_fin(1)-theta2_in(1));
theta3sim1 = theta3in_1+((10/T^3)*t^3-(15/T^4)*t^4+(6/T^5)*t^5)*(theta3fin_1-theta3in_1);
